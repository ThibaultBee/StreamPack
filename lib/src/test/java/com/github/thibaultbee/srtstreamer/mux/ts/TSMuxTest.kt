...
class TSMuxTest {
    ...
    fun `test full constructor`() {
        ...
        val tsMux =
            TSMux(MockMuxListener(), fakeServiceInfo(), listOf(vstream1, vstream2, astream2))
    ...
    fun `test no streams constructor`() {
        ...
        val vstream2 = "video/test2"
        val astream2 = "audio/test"
        val tsMux = TSMux(MockMuxListener(), fakeServiceInfo())
    ...
    fun `test no service but streams constructor`() {
        ...
        val astream2 = "audio/test"
        try {
            TSMux(MockMuxListener(), initialStreams = listOf(vstream1, vstream2, astream2))
            fail()
        } catch (e: Exception) {
        }
    }

...
import io.github.thibaultbee.streampack.ext.srt.internal.endpoints.composites.sinks.utils.toSrtConnectionDescriptor
...
class SrtSink(
    ...
    ) = open(mediaDescriptor.toSrtConnectionDescriptor())

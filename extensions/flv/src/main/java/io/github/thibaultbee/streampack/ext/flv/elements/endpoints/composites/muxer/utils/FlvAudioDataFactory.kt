...
internal fun FlvAacAudioDataFactory(
    ...
    SoundRate.fromSampleRate(codecConfig.sampleRate),
    FlvUtils.soundSizeFromByteFormat(codecConfig.byteFormat),
    FlvUtils.soundTypeFromChannelConfig(codecConfig.channelConfig)
)
 ...
 */
internal fun FlvAacAudioDataFactory(
    soundRate: SoundRate, soundSize: SoundSize, soundType: SoundType
) = FlvAacAudioDataFactory(
    AACAudioDataFactory(

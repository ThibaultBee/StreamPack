...
internal sealed class FlvStream {
    private var sentSequenceStart = false
    ...
    fun create(frame: Frame): List<FLVData> {
        ...
        return createImpl(frame, withSequenceStart)
    }

    abstract fun createImpl(frame: Frame, withSequenceStart: Boolean): List<FLVData>
}
...
internal class AudioFlvStream(codecConfig: AudioCodecConfig) : FlvStream() {
    ...
    override fun createImpl(frame: Frame, withSequenceStart: Boolean): List<FLVData> {

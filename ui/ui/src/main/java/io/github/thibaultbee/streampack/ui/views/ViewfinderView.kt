...
class ViewfinderView @JvmOverloads constructor(
    ...
    var onZoomRatioChanged: ((scale: Float, pinchCenter: PointF) -> Unit)? = null
    ...
    suspend fun requestSurface(
        ...
        configuration.orientationDegrees?.let {
            ...
            builder.setSourceOrientation(OrientationUtils.getSurfaceRotationDegrees(display.rotation))
        }
    ...
    private inner class PinchToZoomOnScaleGestureListener : SimpleOnScaleGestureListener() {
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            ...
            onZoomRatioChanged?.invoke(detector.scaleFactor, PointF(detector.focusX, detector.focusY))
            return true
        }
    }

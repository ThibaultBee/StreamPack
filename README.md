...
```groovy
dependencies {
    implementation 'io.github.thibaultbee:streampack:2.3.0'
}
```
...
```groovy
dependencies {
    implementation 'io.github.thibaultbee:streampack-extension-rtmp:2.3.0'
}
```
...
```groovy
dependencies {
    implementation 'io.github.thibaultbee:streampack-extension-srt:2.3.0'
}
```

...
import io.github.thibaultbee.streampack.core.internal.endpoints.composites.muxers.mp4.boxes.MediaDataBox
...
class Segment(
    ...
    fun add(frame: io.github.thibaultbee.streampack.core.internal.data.Frame, streamPid: Int) {
        val trackSegment = getTrackSegment(streamPid)

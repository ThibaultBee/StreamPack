...
object CameraHelper {
    ...
    fun getTimeOffsetInNsToMonoClock(context: Context, cameraId: String): Long {
        return if (context.getCameraCharacteristics(cameraId)
            ...
            getOffsetInNsFromRealtimeTimestampSource()
        } else {
            getOffsetInNsFromUnknownTimestampSource()
        }
    }

    private fun getOffsetInNsFromUnknownTimestampSource(): Long {
    ...
    private fun getOffsetInNsFromRealtimeTimestampSource(): Long {

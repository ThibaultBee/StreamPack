...
object CompositeEndpoints {
    ...
    internal fun createSrtEndpoint(serviceInfo: TSServiceInfo): IEndpoint {
        ...
        return CompositeEndpoint(TSMuxer().apply { addService(serviceInfo) }, sink)
    }
    ...
    private fun createSrtSink(): ILiveSink {
        return try {
            val clazz =

...
internal fun MediaCodecEncoder(
    ...
    listener: IEncoder.IEncoderListener,
...
internal constructor(
    ...
    private var listener: IEncoder.IEncoderListener = object : IEncoder.IEncoderListener {}
    ...
    override fun setListener(listener: IEncoder.IEncoderListener, listenerExecutor: Executor) {
    ...
    private fun notifyError(e: Exception) {
        var listener: IEncoder.IEncoderListener
    ...
    private inner class EncoderCallback : MediaCodec.Callback() {
        ...
        private fun queueInputFrame(index: Int, frame: Frame) {
    ...
    companion object {
         ...
         * @param info the buffer info
         */
        private fun Frame(mediaCodec: MediaCodec, index: Int, info: BufferInfo): Frame {
            Logger.e("tag", "Frame: in")
